...
{
    public partial class TulparSwitch : CheckBox, ITulparControl
    {
        [Browsable(false)]
        ...
        public override Size GetPreferredSize(Size proposedSize)
        {
            ...
            {
                strSize = NativeText.MeasureLogString(Text, SkinManager.GetLogFontByType(TulparSkinManager.FontType.Subtitle));
            }
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            Color rippleColor = Color.FromArgb(40, // color alpha
                ...
                (SkinManager.Theme == TulparSkinManager.Themes.LIGHT ? Color.Black : Color.White)); // Off color
