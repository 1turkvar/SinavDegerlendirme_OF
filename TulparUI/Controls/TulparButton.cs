...
{
    /// <summary>
    /// Defines the <see cref="TulparButton" />
    /// </summary>
    public class TulparButton : Button, ITulparControl
    {
        ...
        public enum TulparButtonDensity
        {
            Default,
            Dense
        }
        ...
        /// </summary>
        public TulparButtonDensity Density
        {
            get { return _density; }
            set
            {
                _density = value;
                if (_density == TulparButtonDensity.Dense)
        ...
        private TulparButtonType type;
        private TulparButtonDensity _density;

        [Category("Tukpar Skin")]
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TulparButton"/> class.
        /// </summary>
        public TulparButton()
        {
            DrawShadows = true;
            ...
            Type = TulparButtonType.Contained;
            Density = TulparButtonDensity.Default;
        ...
        public override string Text
        {
            ...
            set
            {
                ...
                if (!String.IsNullOrEmpty(value))
                    _textSize = CreateGraphics().MeasureString(value.ToUpper(), SkinManager.getFontByType(TulparSkinManager.FontType.Button2));
                else
                {
                    _textSize.Width = 0;
                    _textSize.Height = 0;
        ...
        private void drawShadowOnParent(object sender, PaintEventArgs e)
        {
            ...
            if (!DrawShadows || Type != TulparButtonType.Contained || Parent == null) return;
        ...
        private void preProcessIcons()
        {
            ...
            float l = (SkinManager.Theme == TulparSkinManager.Themes.LIGHT & (highEmphasis == false | Enabled == false | Type != TulparButtonType.Contained)) ? 0f : 1.5f;
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            if (Type == TulparButtonType.Contained)
            {
                // draw button rect
                // Disabled
                if (!Enabled)
            ...
            if (hoverAnimProgress > 0)
            {
                using (SolidBrush hoverBrush = new SolidBrush(Color.FromArgb(
                    (int)(HighEmphasis && Type == TulparButtonType.Contained ? hoverAnimProgress * 80 : hoverAnimProgress * SkinManager.BackgroundHoverColor.A), (UseAccentColor ? (HighEmphasis && Type == TulparButtonType.Contained ?
                    ...
                    (Type == TulparButtonType.Contained && HighEmphasis ? SkinManager.ColorScheme.LightPrimaryColor : // Contained with Emphasis without accent
            ...
            if (focusAnimProgress > 0)
            {
                using (SolidBrush focusBrush = new SolidBrush(Color.FromArgb(
                    (int)(HighEmphasis && Type == TulparButtonType.Contained ? focusAnimProgress * 80 : focusAnimProgress * SkinManager.BackgroundFocusColor.A), (UseAccentColor ? (HighEmphasis && Type == TulparButtonType.Contained ?
                    SkinManager.ColorScheme.AccentColor.Lighten(0.5f) : // Contained with Emphasis - with accent
                    SkinManager.ColorScheme.AccentColor) : // Not Contained Or Low Emphasis - with accent
                    (Type == TulparButtonType.Contained && HighEmphasis ? SkinManager.ColorScheme.LightPrimaryColor : // Contained with Emphasis without accent
                    SkinManager.ColorScheme.PrimaryColor)).RemoveAlpha()))) // Normal or Emphasis without accent
            ...
            if (Type == TulparButtonType.Outlined)
            {
            ...
            if (_animationManager.IsAnimating())
            {
                ...
                for (var i = 0; i < _animationManager.GetAnimationCount(); i++)
                {
                    ...
                    using (Brush rippleBrush = new SolidBrush(
                        ...
                        (Type == TulparButtonType.Contained && HighEmphasis ? (UseAccentColor ?
                            ...
                            SkinManager.Theme == TulparSkinManager.Themes.LIGHT ? SkinManager.ColorScheme.PrimaryColor : SkinManager.ColorScheme.LightPrimaryColor))))) // Normal
                    {
            ...
            Color textColor = Enabled ? (HighEmphasis ? (Type == TulparButtonType.Text || Type == TulparButtonType.Outlined) ?
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                NativeText.DrawMultilineTransparentText(
                    ...
                    SkinManager.GetLogFontByType(TulparSkinManager.FontType.Button2),
                    textColor,
                    textRect.Location,
                    textRect.Size,
