...
{
    public class TulparDialog : TulparForm
    {
        ...
        private TulparButton _validationButton = new TulparButton();
        private TulparButton _cancelButton = new TulparButton();
        ...
        /// </summary>
        public TulparDialog(TulparForm ParentForm, string Title, string Text, string ValidationButtonText, bool ShowCancelButton, string CancelButtonText, bool UseAccentColor)
        {
            _formOverlay = new TulparForm
            {
            ...
            _validationButton = new TulparButton
            {
                AutoSize = false,
                DialogResult = DialogResult.OK,
                DrawShadows = false,
                Type = TulparButton.TulparButtonType.Text,
                UseAccentColor = UseAccentColor,
                Text = ValidationButtonText
            };
            _cancelButton = new TulparButton
            {
                AutoSize = false,
            ...
            Width = 560;
            int TextWidth = TextRenderer.MeasureText(_text, SkinManager.getFontByType(TulparSkinManager.FontType.Body1)).Width;
            ...
            int _buttonWidth = ((TextRenderer.MeasureText(ValidationButtonText, SkinManager.getFontByType(TulparSkinManager.FontType.Button))).Width + 32);
            ...
            _buttonWidth = ((TextRenderer.MeasureText(CancelButtonText, SkinManager.getFontByType(TulparSkinManager.FontType.Button))).Width + 32);
        ...
        public TulparDialog(TulparForm ParentForm) : this(ParentForm, "Title", "Dialog box", "OK", false, "Cancel", false)
        {
        }

        public TulparDialog(TulparForm ParentForm, string Text) : this(ParentForm, "Title", Text, "OK", false, "Cancel", false)
        {
        }

        public TulparDialog(TulparForm ParentForm, string Title, string Text) : this(ParentForm, Title, Text, "OK", false, "Cancel", false)
        {
        }

        public TulparDialog(TulparForm ParentForm, string Title, string Text, string ValidationButtonText) : this(ParentForm, Title, Text, ValidationButtonText, false, "Cancel", false)
        {
        }

        public TulparDialog(TulparForm ParentForm, string Title, string Text, bool ShowCancelButton) : this(ParentForm, Title, Text, "OK", ShowCancelButton, "Cancel", false)
        {
        }

        public TulparDialog(TulparForm ParentForm, string Title, string Text, bool ShowCancelButton, string CancelButtonText) : this(ParentForm, Title, Text, "OK", ShowCancelButton, CancelButtonText, false)
        {
        }

        public TulparDialog(TulparForm ParentForm, string Title, string Text, string ValidationButtonText, bool ShowCancelButton, string CancelButtonText) : this(ParentForm, Title, Text, ValidationButtonText, ShowCancelButton, CancelButtonText, false)
        {
        }
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                ...
                NativeText.DrawTransparentText(
                    _title,
                    SkinManager.GetLogFontByType(TulparSkinManager.FontType.H6),
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                ...
                NativeText.DrawMultilineTransparentText(
                    _text,
                    SkinManager.GetLogFontByType(TulparSkinManager.FontType.Body1),
                    SkinManager.TextHighEmphasisColor,
                    textRect.Location,
                    textRect.Size,
