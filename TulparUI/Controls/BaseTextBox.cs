...
{
    [ToolboxItem(false)]
    public class IBaseTextBox : TextBox, ITulparControl
    {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == WM_PAINT && String.IsNullOrEmpty(Text) && !Focused)
            {
                using (NativeTextRenderer NativeText = new NativeTextRenderer(Graphics.FromHwnd(m.HWnd)))
                {
                    ...
                    Hint,
                    SkinManager.getFontByType(TulparSkinManager.FontType.Subtitle1),
                    Enabled ?
    ...
    [ToolboxItem(false)]
    public class BaseMaskedTextBox : MaskedTextBox, ITulparControl
    {
        //Properties for managing the material design properties
        [Browsable(false)]
        public int Depth { get; set; }
    ...
    [ToolboxItem(false)]
    public class BaseTextBoxContextMenuStrip : TulparContextMenuStrip
    {
        public readonly ToolStripItem undo = new TulparToolStripMenuItem { Text = "Undo" };
        public readonly ToolStripItem seperator1 = new ToolStripSeparator();
        public readonly ToolStripItem cut = new TulparToolStripMenuItem { Text = "Cut" };
        public readonly ToolStripItem copy = new TulparToolStripMenuItem { Text = "Copy" };
        public readonly ToolStripItem paste = new TulparToolStripMenuItem { Text = "Paste" };
        public readonly ToolStripItem delete = new TulparToolStripMenuItem { Text = "Delete" };
        public readonly ToolStripItem seperator2 = new ToolStripSeparator();
        public readonly ToolStripItem selectAll = new TulparToolStripMenuItem { Text = "Select All" };
