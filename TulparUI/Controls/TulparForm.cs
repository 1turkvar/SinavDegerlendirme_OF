...
{
    public partial class TulparForm : Form, ITulparControl
    {
        ...
        [Category("Tulpar Skin"), Browsable(true), DisplayName("Form Style"), DefaultValue(FormStyles.ActionBar_40)]
        ...
        [Category("Drawer")]
        public TulparTabControl DrawerTabControl { get; set; }
        ...
        private TulparDrawerForm drawerForm = new TulparDrawerForm();
        ...
        private TulparDrawer drawerControl = new TulparDrawer();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (ControlBox == true && _formStyle != FormStyles.ActionBar_None && _formStyle != FormStyles.StatusAndActionBar_None)
            {
                ...
                using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
                {
                    ...
                    NativeText.DrawTransparentText(Text, SkinManager.GetLogFontByType(TulparSkinManager.FontType.H6), //H&
    ...
    public class TulparDrawerForm : Form
    {
        public MouseWheelRedirector MouseWheelRedirector;

        public TulparDrawerForm()
        {
