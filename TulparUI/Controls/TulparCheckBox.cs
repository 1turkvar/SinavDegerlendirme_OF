...
{
    public partial class TulparCheckBox : CheckBox, ITulparControl
    {
        ...
        public override Size GetPreferredSize(Size proposedSize)
        {
            ...
            {
                strSize = NativeText.MeasureLogString(Text, SkinManager.GetLogFontByType(TulparSkinManager.FontType.Body1));
            }
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            if (Ripple)
            {
                ...
                using (SolidBrush rippleBrush = new SolidBrush(Color.FromArgb((int)(40 * animationValue),
                    !Checked ? (SkinManager.Theme == TulparSkinManager.Themes.LIGHT ? Color.Black : Color.White) : brush.Color))) // no animation
                {
            ...
            if (Ripple && _rippleAM.IsAnimating())
            {
                for (int i = 0; i < _rippleAM.GetAnimationCount(); i++)
                {
                    ...
                    using (SolidBrush rippleBrush = new SolidBrush(Color.FromArgb((int)((animationValue * 40)), !Checked ? (SkinManager.Theme == TulparSkinManager.Themes.LIGHT ? Color.Black : Color.White) : brush.Color)))
                    {
                        g.FillEllipse(rippleBrush, new Rectangle(animationSource.X - rippleSize / 2, animationSource.Y - rippleSize / 2, rippleSize, rippleSize));
                    }
                }
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                ...
                NativeText.DrawTransparentText(Text, SkinManager.GetLogFontByType(TulparSkinManager.FontType.Body1),
