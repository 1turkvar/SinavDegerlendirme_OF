...
{
    public partial class TulparTextBox : Control, ITulparControl
    {
        readonly TulparContextMenuStrip cms = new BaseTextBoxContextMenuStrip();
        ContextMenuStrip _lastContextMenuStrip = new ContextMenuStrip();


        //Properties for managing the Tulpar design properties
        [Browsable(false)]
        ...
        //Unused properties
        [Browsable(false)]
        public override Image BackgroundImage { get => backgroundImage; set => backgroundImage = value; }
        ...
        //Tulpar Skin properties

        private bool _UseTallSize;

        [Category("Tulpar Skin"), DefaultValue(true), Description("Using a larger size enables the hint to always be visible")]
        ...
        [Category("Tulpar Skin"), DefaultValue(false), Description("Assistive elements provide additional detail about text entered into text fields. Could be Helper text or Error message.")]
        ...
        [Category("Tulpar Skin"), DefaultValue(""), Localizable(true), Description("Helper text conveys additional guidance about the input field, such as how it will be used.")]
        ...
        [Category("Tulpar Skin"), DefaultValue(""), Localizable(true), Description("When text input isn't accepted, an error message can display instructions on how to fix it. Error messages are displayed below the input line, replacing helper text until fixed.")]
        ...
        [Category("Tulpar Skin"), DefaultValue(""), Localizable(true)]
        public string Hint
        {
        ...
        [Category("Tulpar Skin"), DefaultValue(true)]
        public bool UseAccent { get; set; }

        private Image _leadingIcon;

        [Category("Tulpar Skin"), Browsable(true), Localizable(false)]
        /// <summary>
        ...
        [Category("Tulpar Skin"), DefaultValue(PrefixSuffixTypes.None), Description("Set Prefix/Suffix/None")]
        ...
        [Category("Tulpar Skin"), DefaultValue(""), Localizable(true), Description("Set Prefix or Suffix text")]
        ...
        [Category("Tulpar Skin"), DefaultValue(false), Description("Select next control which have TabStop property set to True when enter key is pressed.")]
        ...
        protected readonly IBaseTextBox baseTextBox;

        public TulparTextBox()
        {
            // Tulpar Properties
            UseAccent = true;
            ...
            Font = SkinManager.getFontByType(TulparSkinManager.FontType.Subtitle);

            baseTextBox = new IBaseTextBox
            {
            ...
            if (_prefixsuffix == PrefixSuffixTypes.Prefix && _prefixsuffixText != null && _prefixsuffixText.Length > 0 && (isFocused || userTextPresent || !hasHint))
            {
                using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
                {
                    Rectangle prefixRect = new Rectangle(
                        ...
                        //                        NativeText.MeasureLogString(_prefixsuffixText, SkinManager.getLogFontByType(TulparSkinManager.fontType.Subtitle1)).Width,
                        _prefix_padding,
                    ...
                    _prefixsuffixText,
                    SkinManager.GetLogFontByType(TulparSkinManager.FontType.Subtitle),
            ...
            if (_prefixsuffix == PrefixSuffixTypes.Suffix && _prefixsuffixText != null && _prefixsuffixText.Length > 0 && (isFocused || userTextPresent || !hasHint))
            {
                using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
                {
                    Rectangle suffixRect = new Rectangle(
                        ...
                        hasHint && UseTallSize ? (hintRect.Y + hintRect.Height) - 2 : ClientRectangle.Y,
                        //NativeText.MeasureLogString(_prefixsuffixText, SkinManager.getLogFontByType(TulparSkinManager.fontType.Subtitle1)).Width + PREFIX_SUFFIX_PADDING,
                        _suffix_padding,
                        hasHint && UseTallSize ? LINE_Y - (hintRect.Y + hintRect.Height) : LINE_Y);
        ...
        private void PreProcessIcons()
        {
            ...
            float l = (SkinManager.Theme == TulparSkinManager.Themes.LIGHT) ? 0f : 1f;
        ...
        private void UpdateRects()
        {
            ...
            if (_prefixsuffix == PrefixSuffixTypes.Prefix && _prefixsuffixText != null && _prefixsuffixText.Length > 0)
            {
                ...
                {
                    _prefix_padding = NativeText.MeasureLogString(_prefixsuffixText, SkinManager.GetLogFontByType(TulparSkinManager.FontType.Subtitle)).Width + PREFIX_SUFFIX_PADDING;
                    _left_padding += _prefix_padding;
                }
            }
            else
            ...
            if (_prefixsuffix == PrefixSuffixTypes.Suffix && _prefixsuffixText != null && _prefixsuffixText.Length > 0)
            {
                using (NativeTextRenderer NativeText = new NativeTextRenderer(CreateGraphics()))
                {
                    _suffix_padding = NativeText.MeasureLogString(_prefixsuffixText, SkinManager.GetLogFontByType(TulparSkinManager.FontType.Subtitle)).Width + PREFIX_SUFFIX_PADDING;
