...
{
    public class TulparDrawer : Control, ITulparControl
    {
        ...
        private TulparTabControl _baseTabControl;

        [Category("Behavior")]
        public TulparTabControl BaseTabControl
        {
        ...
        private void preProcessIcons()
        {
            ...
            float l = UseColors ? SkinManager.ColorScheme.TextColor.R / 255 : SkinManager.Theme == TulparSkinManager.Themes.LIGHT ? 0f : 1f;
        ...
        public TulparDrawer()
        {
            ...
            MouseWheel += TulparDrawer_MouseWheel;
        }

        private void TulparDrawer_MouseWheel(object sender, MouseEventArgs e)
        {
            int step = 20;
            if (e.Delta > 0)
            {
        ...
        private new void Paint(PaintEventArgs e)
        {
            ...
            if (_clickAnimManager.IsAnimating())
            {
                var rippleBrush = new SolidBrush(Color.FromArgb((int)(70 - (clickAnimProgress * 70)),
                    ...
                    SkinManager.Theme == TulparSkinManager.Themes.LIGHT ? SkinManager.ColorScheme.PrimaryColor : // light theme
            ...
            foreach (TabPage tabPage in _baseTabControl.TabPages)
            {
                ...
                Brush bgBrush = new SolidBrush(Color.FromArgb(CalculateAlpha(60, 0, currentTabIndex, clickAnimProgress, 1 - showHideAnimProgress),
                    ...
                    SkinManager.Theme == TulparSkinManager.Themes.LIGHT ? SkinManager.ColorScheme.PrimaryColor : // default light
                ...
                IntPtr textFont = SkinManager.GetLogFontByType(TulparSkinManager.FontType.Caption); //Menu Font
