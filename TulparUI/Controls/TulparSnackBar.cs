...
{
    public class TulparSnackBar : TulparForm
    {
        ...
        private TulparButton _actionButton = new TulparButton();
        ...
        [Category("Tulpar Skin"), DefaultValue(false), DisplayName("Use Accent Color")]
        ...
        /// </summary>
        [Category("Tulpar Skin"), DefaultValue(2000)]
        public int Duration
        {
            get
            {
        ...
        /// </summary>
        [Category("Tulpar Skin"), DefaultValue("SnackBar text")]
        ...
        [Category("Tulpar Skin"), DefaultValue(false), DisplayName("Show Action Button")]
        ...
        /// The Text which gets displayed as the Content
        /// </summary>
        [Category("Tulpar Skin"), DefaultValue("OK")]
        ...
        /// </summary>
        //public ObservableCollection<TulparButton> Buttons { get; set; }
        ...
        /// </summary>
        public TulparSnackBar(string Text, int Duration, bool ShowActionButton, string ActionButtonText, bool UseAccentColor)
        {
            this.Text = Text;
            ...
            _actionButton = new TulparButton
            {
                AutoSize = false,
        ...
        public TulparSnackBar() : this("SnackBar Text", 3000, false, "OK", false)
        {
        }

        public TulparSnackBar(string Text) : this(Text, 3000, false, "OK", false)
        {
        }

        public TulparSnackBar(string Text, int Duration) : this(Text, Duration, false, "OK", false)
        {
        }

        public TulparSnackBar(string Text, string ActionButtonText) : this(Text, 3000, true, ActionButtonText, false)
        {
        }

        public TulparSnackBar(string Text, string ActionButtonText, bool UseAccentColor) : this(Text, 3000, true, ActionButtonText, UseAccentColor)
        {
        }

        public TulparSnackBar(string Text, int Duration, string ActionButtonText) : this(Text, Duration, true, ActionButtonText, false)
        {
        }

        public TulparSnackBar(string Text, int Duration, string ActionButtonText, bool UseAccentColor) : this(Text, Duration, true, ActionButtonText, UseAccentColor)
        {
        }
        ...
        private void UpdateRects()
        {
            ...
            {
                int _buttonWidth = ((TextRenderer.MeasureText(ActionButtonText, SkinManager.getFontByType(TulparSkinManager.FontType.Button))).Width + 32);
            ...
            Width = TextRenderer.MeasureText(_text, SkinManager.getFontByType(TulparSkinManager.FontType.Body2)).Width + (2 * LEFT_RIGHT_PADDING) + _actionButton.Width + 48;
            Region = System.Drawing.Region.FromHrgn(CreateRoundRectRgn(0, 0, Width, Height, 6, 6));
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                ...
                NativeText.DrawTransparentText(
                    _text,
                    SkinManager.GetLogFontByType(TulparSkinManager.FontType.Body2),
