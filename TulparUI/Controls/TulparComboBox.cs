...
{
    public partial class TulparComboBox : ComboBox, ITulparControl
    {
        ...
        private void CustomDrawItem(object sender, System.Windows.Forms.DrawItemEventArgs e)
        {
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                NativeText.DrawTransparentText(
                Text,
                SkinManager.getFontByType(TulparSkinManager.FontType.Subtitle),
        ...
        public void recalculateAutoSize()
        {
            ...
            using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
            {
                ...
                {
                    int newWidth = NativeText.MeasureLogString(s, SkinManager.GetLogFontByType(TulparSkinManager.FontType.Subtitle)).Width + vertScrollBarWidth + padding;
