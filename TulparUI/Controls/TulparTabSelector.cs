...
{
    public partial class TulparTabSelector : Control, ITulparControl
    {
        [Browsable(false)]
        ...
        [Category("Tulpar Skin"), Browsable(true)]
        ...
        [Category("Tulpar Skin"), Browsable(true), DisplayName("Tab Indicator Height"), DefaultValue(2)]
        ...
        [Category("Tulpar Skin"), Browsable(true), DisplayName("Tab Label"), DefaultValue(TabLabelStyle.Text)]
        ...
        protected override void OnCreateControl()
        {
            ...
            Font = SkinManager.getFontByType(TulparSkinManager.FontType.Button);
        }
                ...
                if (_tabLabel != TabLabelStyle.Icon)
                {
                    ...
                    using (NativeTextRenderer NativeText = new NativeTextRenderer(g))
                    {
                        ...
                        else
                        {
                            ...
                            CharacterCasing == CustomCharacterCasing.Lower ? tabPage.Text.ToLower() :
                            CharacterCasing == CustomCharacterCasing.Proper ? textInfo.ToTitleCase(tabPage.Text.ToLower()) : tabPage.Text,
                            SkinManager.getFontByType(TulparSkinManager.FontType.Button),
                            Color.FromArgb(CalculateTextAlpha(currentTabIndex, animationProgress), SkinManager.ColorScheme.TextColor),
                            textLocation.Location,
                            textLocation.Size,
                            NativeTextRenderer.TextAlignFlags.Center | NativeTextRenderer.TextAlignFlags.Middle);
