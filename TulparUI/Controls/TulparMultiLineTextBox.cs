...
{
    public partial class TulparMultiLineTextBox : Control, ITulparControl
    {
        ...
        [Browsable(true)]
        [Category("Tulpar Skin"), DefaultValue(true), Description("Defines whether TulparMultiLineTextBox allows scrolling of text. This property is independent of the ScrollBars property")]
        ...
        [Category("Tulpar Skin"), DefaultValue(false), Description("Select next control which have TabStop property set to True when enter key is pressed. To add enter in text, the user must press CTRL+Enter")]
